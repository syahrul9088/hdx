...
const getReff = () => new Promise((resolve, reject) => {
    fetch('https://vy.tc/j6oTX24', {
        ...
        const result = {
            reff: $('input[id=entries-referrer_id]').attr('value')
        }
...
const functionGoRegist = (ip, name, email, reff) => new Promise((resolve, reject) => {
    ...
    params.append('Entries[contest_id]', '23443');
    ...
    fetch(`https://vyper.io/entries/create?contest_id=23443&referrer_id=${reff}&display_type=Landing%20Page`, { 
        method: 'POST', 
        body: params
    })
    .then(res => res.text())
